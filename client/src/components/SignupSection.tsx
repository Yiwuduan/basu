  ...
  return (
    <section id="signup" className="py-[160px] bg-black relative z-10" style={{ backgroundColor: '#000000' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Subcopy */}
        <p className="text-[20px] text-[#CCCCCC] text-center max-w-[640px] mx-auto mb-16" data-testid="text-signup-description">
        ...
        {step === 1 && (
          <div className="max-w-4xl mx-auto">
            <h3 className="text-[32px] font-bold text-white text-center mb-12" data-testid="text-question-1">
              ...
              {learningApproaches.map((approach) => (
                ...
                >
                  <div className="aspect-[4/3] relative">
                    ...
                    {formData.learningApproach === approach.id && (
                      <div className="absolute top-4 right-4 w-8 h-8 bg-[#FF4D00] rounded-full flex items-center justify-center">
                        <Check className="w-5 h-5 text-white" />
                      </div>
                    )}
                  </div>
                  <div className="p-6 bg-[#111111]">
                    <h4 className="text-[20px] font-bold text-white mb-2">{approach.label}</h4>
                    <p className="text-[16px] text-[#999999]">{approach.description}</p>
                  </div>
                </button>
              ))}
            </div>
            <div className="flex justify-center">
              <button
                ...
                className="bg-[#FF4D00] text-white text-[18px] font-bold uppercase px-16 py-5 rounded-lg border-2 border-[#FF4D00] cta-transition hover:bg-black hover:text-[#FF4D00] disabled:opacity-30 disabled:hover:bg-[#FF4D00] disabled:hover:text-white"
        ...
        {step === 2 && (
          <div className="max-w-4xl mx-auto">
            <h3 className="text-[32px] font-bold text-white text-center mb-12" data-testid="text-question-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              {participationReasons.map((reason) => (
                ...
                >
                  ...
                  <div className="p-6 bg-[#111111]">
                    <h4 className="text-[20px] font-bold text-white mb-2">{reason.label}</h4>
                    <p className="text-[16px] text-[#999999]">{reason.description}</p>
                  </div>
                </button>
              ))}
            </div>
            <div className="flex justify-center gap-4">
              <button
                onClick={() => setStep(1)}
                className="bg-[#111111] text-white text-[18px] font-bold uppercase px-12 py-5 rounded-lg border-2 border-[#333333] cta-transition hover:border-[#FF4D00]"
        ...
        {step === 3 && (
          <div className="max-w-[560px] mx-auto">
            <h3 className="text-[32px] font-bold text-white text-center mb-12" data-testid="text-question-3">
            ...
            <div className="space-y-6 mb-12">
              <input
                ...
                required
                className="w-full text-[20px] py-5 px-6 bg-[#111111] border border-[#333333] text-white rounded-lg input-focus transition-all"
        ...
        {step === 4 && (
          <form onSubmit={handleSubmit} className="max-w-[560px] mx-auto">
            <h3 className="text-[32px] font-bold text-white text-center mb-12" data-testid="text-question-4">
            ...
            <div className="space-y-6 mb-12">
              ...
              <textarea
                ...
                rows={6}
                required
                className="w-full text-[20px] py-5 px-6 bg-[#111111] border border-[#333333] text-white rounded-lg resize-none input-focus transition-all leading-relaxed"
